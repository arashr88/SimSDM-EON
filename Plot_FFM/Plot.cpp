...
int main () {
	...
	// For FuFVF
	ofstream MS ("/home/mt1ger/Desktop/Simulator/SimSDM-EON/Plot_FullyFlex/MaxSec.txt");
	string Plot_Exec = "/home/mt1ger/Desktop/Simulator/SimSDM-EON/Plot_FullyFlex/Plot";
	system (Plot_Exec.c_str ());

	int Temp; 
	ifstream MaxSec;
	MaxSec.open ("/home/mt1ger/Desktop/Simulator/SimSDM-EON/Plot_FullyFlex/MaxSec.txt");
	while (!MaxSec.eof ()) {
		MaxSec >> Temp;
