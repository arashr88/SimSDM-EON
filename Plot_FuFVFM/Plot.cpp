...
int main () {
	...
	// For FuFVF
	ofstream MS ("/home/mt1ger/Desktop/Simulator/SimSDM-EON/Plot_FuFVF/MaxSec.txt");
	string Plot_Exec = "/home/mt1ger/Desktop/Simulator/SimSDM-EON/Plot_FuFVF/Plot";
	system (Plot_Exec.c_str ());

	int Temp; 
	ifstream MaxSec;
	MaxSec.open ("/home/mt1ger/Desktop/Simulator/SimSDM-EON/Plot_FuFVF/MaxSec.txt");
	while (!MaxSec.eof ()) {
		MaxSec >> Temp;
